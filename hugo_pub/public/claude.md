...
> Claude Cowork와 Claude Code의 핵심 사용법을 정리한 노트입니다.
...
- Word 문서 (`.docx`) 생성 및 편집
- Excel 스프레드시트 (`.xlsx`) 작성
- PowerPoint 프레젠테이션 (`.pptx`) 제작
- PDF 생성 및 처리
...
> [!warning] 중요
> Cowork가 파일에 접근하려면 반드시 **폴더 선택 권한**을 부여해야 합니다.
...
프로젝트 루트에 `CLAUDE.md` 파일을 만들어 Claude가 프로젝트 컨텍스트를 이해하도록 돕습니다.
...
#claude #AI #anthropic #cowork #claude-code #자동화 #개발도구
